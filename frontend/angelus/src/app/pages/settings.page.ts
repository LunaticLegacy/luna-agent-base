...
@Component({
    ...
    <div class="settings-grid">
      <div class="settings-card">
        ...
        <div class="form-group">
          ...
          <span class="hint">Flask 后端服务地址</span>
        </div>
        <div class="form-group">
  ...
  styles: [`
    ...
    .settings-card h3 { font-size:.95rem; font-weight:600; color:#F1F5F9; margin:0 0 1rem; padding-bottom:.75rem; border-bottom:1px solid rgba(148,163,184,.08); }
    .form-group { margin-bottom:1rem; }
    .form-group:last-child { margin-bottom:0; }
    .form-group label { display:block; font-size:.82rem; color:#94A3B8; margin-bottom:.35rem; }
    .form-group.inline { display:flex; align-items:center; gap:.6rem; }
...
export class SettingsPage {
  ...
  apiTimeout = signal(30);
  reconnectInterval = signal(5);
  ...
  saveSettings() {
    this.state.setApiBaseUrl(this.apiUrl());
